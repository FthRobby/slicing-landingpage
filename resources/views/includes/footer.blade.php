        ...
        <div class="border-color-footer-2-3 mx-auto">
            ...
            <div class="container mx-auto flex pt-12 flex-col lg:flex-row items-center space-y-5 lg:space-y-0">
                <div class="flex title-font font-medium items-center text-gray-900 mb-4 lg:mb-0 md:mb-0 space-x-5"
                    ...
                    <svg class="social-media-c-footer-2-3" width="30" height="30" viewBox="0 0 30 30" fill="none"
                    ...
                    <svg class="social-media-p-footer-2-3" width="30" height="30" viewBox="0 0 30 30" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
